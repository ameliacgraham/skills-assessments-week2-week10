...
class Brand(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Brand name: {}, brand_id: {}, founded: {}, discontinued: {}".format(self.name, self.brand_id,
                                                                   self.founded, self.discontinued)
...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Model name: {} model_id: {} year: {}".format(self.name, self.model_id, self.year)
